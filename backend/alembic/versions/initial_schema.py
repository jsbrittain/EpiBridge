...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('created_at', sa.DateTime(timezone=True), nullable=False, server_default=sa.text('now()')),
        sa.UniqueConstraint('execution_environment_id', 'dependency_hash', name='uq_execution_image_env_hash'),
    )
    op.create_table(
        'roles',
        sa.Column('id', postgresql.UUID(), nullable=False, primary_key=True),
    ...
    op.create_table(
        ...
        sa.Column('role', sa.Enum('RESEARCHER', 'MODERATOR', 'MAINTAINER', 'ADMIN', name='user_role'), nullable=False),
        sa.Column('created_at', sa.DateTime(timezone=True), nullable=False, server_default=sa.text('now()')),
        sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False, server_default=sa.text('now()')),
    ...
    op.create_table(
        'role_capabilities',
        sa.Column('role_id', postgresql.UUID(), sa.ForeignKey('roles.id', ondelete='CASCADE'), nullable=False, primary_key=True),
        sa.Column('capability_name', sa.String(100), sa.ForeignKey('capabilities.name', ondelete='CASCADE'), nullable=False, primary_key=True),
    )
    op.create_table(
        'sessions',
    ...
    op.create_table(
        ...
        sa.Column('data_resource_id', postgresql.UUID(), sa.ForeignKey('data_resources.id')),
        sa.Column('version', sa.String(50), nullable=False),
        sa.Column('title', sa.String(255), nullable=False),
        sa.Column('content', sa.Text(), nullable=False),
        sa.Column('published_by_id', postgresql.UUID(), sa.ForeignKey('users.id'), nullable=False),
        sa.Column('published_at', sa.DateTime(timezone=True), nullable=False, server_default=sa.text('now()')),
        sa.UniqueConstraint('terms_type', 'data_resource_id', 'version', name='uq_terms_version'),
    )
    op.create_table(
        'user_capabilities',
        sa.Column('user_id', postgresql.UUID(), sa.ForeignKey('users.id', ondelete='CASCADE'), nullable=False, primary_key=True),
        sa.Column('capability_name', sa.String(100), sa.ForeignKey('capabilities.name', ondelete='CASCADE'), nullable=False, primary_key=True),
    )
    op.create_table(
        'user_roles',
    ...
    op.create_table(
        ...
        sa.Column('created_by_id', postgresql.UUID(), sa.ForeignKey('users.id'), nullable=False),
        sa.Column('execution_environment_id', postgresql.UUID(), sa.ForeignKey('execution_environments.id')),
        sa.Column('name', sa.String(255), nullable=False),
        ...
        sa.Column('build_strategy', sa.String(20), nullable=False, server_default=sa.text("'institutional'")),
        sa.Column('build_status', sa.String(64), nullable=False),
        sa.Column('build_error', sa.Text(), nullable=False),
        sa.Column('execution_image_id', postgresql.UUID(), sa.ForeignKey('execution_images.id')),
        sa.Column('created_at', sa.DateTime(timezone=True), nullable=False, server_default=sa.text('now()')),
        sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False, server_default=sa.text('now()')),
    )
    op.create_table(
        ...
        sa.Column('actor_id', postgresql.UUID(), sa.ForeignKey('users.id'), nullable=False),
    ...
    op.create_table(
        'project_memberships',
        sa.Column('project_id', postgresql.UUID(), sa.ForeignKey('projects.id'), nullable=False, primary_key=True),
        sa.Column('user_id', postgresql.UUID(), sa.ForeignKey('users.id'), nullable=False, primary_key=True),
        sa.Column('created_by_id', postgresql.UUID(), sa.ForeignKey('users.id'), nullable=False),
        sa.Column('created_at', sa.DateTime(timezone=True), nullable=False, server_default=sa.text('now()')),
    )
    op.create_table(
        ...
        sa.Column('project_id', postgresql.UUID(), sa.ForeignKey('projects.id'), nullable=False, primary_key=True),
        sa.Column('data_resource_id', postgresql.UUID(), sa.ForeignKey('data_resources.id'), nullable=False, primary_key=True),
        sa.Column('created_by_id', postgresql.UUID(), sa.ForeignKey('users.id'), nullable=False),
        sa.Column('created_at', sa.DateTime(timezone=True), nullable=False, server_default=sa.text('now()')),
    ...
    op.create_table(
        ...
        sa.Column('terms_of_service_id', postgresql.UUID(), sa.ForeignKey('terms_of_service.id', ondelete='CASCADE'), nullable=False),
        sa.Column('accepted_at', sa.DateTime(timezone=True), nullable=False, server_default=sa.text('now()')),
        sa.UniqueConstraint('user_id', 'terms_of_service_id', name='uq_user_terms_acceptance'),
    )
    op.create_table(
        'ai_bundle_reviews',
        sa.Column('id', postgresql.UUID(), nullable=False, primary_key=True),
        sa.Column('bundle_id', postgresql.UUID(), sa.ForeignKey('analysis_bundles.id'), nullable=False),
        sa.Column('status', sa.String(64), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('analysis_bundle_id', postgresql.UUID(), sa.ForeignKey('analysis_bundles.id'), nullable=False, primary_key=True),
        sa.Column('data_resource_id', postgresql.UUID(), sa.ForeignKey('data_resources.id'), nullable=False, primary_key=True),
    )
    op.create_table(
        'build_requests',
        sa.Column('id', postgresql.UUID(), nullable=False, primary_key=True),
        sa.Column('execution_environment_id', postgresql.UUID(), sa.ForeignKey('execution_environments.id'), nullable=False),
        sa.Column('analysis_bundle_id', postgresql.UUID(), sa.ForeignKey('analysis_bundles.id'), nullable=False),
        sa.Column('dependency_hash', sa.String(64), nullable=False),
        sa.Column('builder_type', sa.String(50), nullable=False),
        sa.Column('status', sa.String(64), nullable=False),
        sa.Column('execution_image_id', postgresql.UUID(), sa.ForeignKey('execution_images.id')),
    ...
    op.create_table(
        ...
        sa.Column('status', sa.String(64), nullable=False),
        sa.Column('log', sa.Text(), nullable=False),
        sa.Column('requested_by_id', postgresql.UUID(), sa.ForeignKey('users.id'), nullable=False),
        sa.Column('created_at', sa.DateTime(timezone=True), nullable=False, server_default=sa.text('now()')),
        sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False, server_default=sa.text('now()')),
    )
    op.create_table(
        ...
        sa.Column('parameter_overrides', sa.JSON(), nullable=False, server_default=sa.text("'{}'::json")),
        ...
        sa.Column('output_files', sa.JSON(), nullable=False, server_default=sa.text("'[]'::json")),
        sa.Column('bundle_content_hash', sa.String(64), nullable=False, server_default=sa.text("''")),
        sa.Column('requested_by_id', postgresql.UUID(), sa.ForeignKey('users.id'), nullable=False),
        sa.Column('created_at', sa.DateTime(timezone=True), nullable=False, server_default=sa.text('now()')),
        sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False, server_default=sa.text('now()')),
    )
    op.create_table(
        'output_sets',
        sa.Column('id', postgresql.UUID(), nullable=False, primary_key=True),
        sa.Column('execution_request_id', postgresql.UUID(), sa.ForeignKey('execution_requests.id'), nullable=False),
        sa.Column('status', sa.String(64), nullable=False),
    ...
    op.create_table(
        'outputs',
        sa.Column('id', postgresql.UUID(), nullable=False, primary_key=True),
        sa.Column('output_set_id', postgresql.UUID(), sa.ForeignKey('output_sets.id'), nullable=False),
        sa.Column('filename', sa.String(255), nullable=False),
        sa.Column('size', sa.Integer(), nullable=False),
        sa.Column('created_at', sa.DateTime(timezone=True), nullable=False, server_default=sa.text('now()')),
    )
    op.create_index('ix_terms_of_service_terms_type', 'terms_of_service', ['terms_type'])
    op.create_index('ix_terms_of_service_data_resource_id', 'terms_of_service', ['data_resource_id'])
    ...
    op.create_index('ix_terms_acceptance_terms_of_service_id', 'terms_acceptance', ['terms_of_service_id'])
    op.create_index('ix_terms_acceptance_user_id', 'terms_acceptance', ['user_id'])
    op.create_index("ix_validation_requests_bundle_id", "validation_requests", ["analysis_bundle_id"])
    op.create_index("ix_validation_requests_project_id", "validation_requests", ["project_id"])
